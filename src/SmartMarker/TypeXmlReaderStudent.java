 ...
 * 
 */
public class TypeXmlReaderStudent extends TypeXmlReader {
	private final static String CLASS_NAME = TypeXmlReaderStudent.class.getName();
	private final static Logger LOGGER = Logger.getLogger(CLASS_NAME);
	BufferedImage imgKaryotype; // may be null

	/**
	 * Populate the attributes from a filename
	 * 
	 * @param fileName
	 *            The absolute path to the kry file
		...
		try {
			...
			class FrameSource {
				...
				public String toString() {
					return "FrameSource[stackheight=" + stackheight + " roix=" + roix + " roiy="
							+ roiy + " roiwidth=" + roiwidth + " roiheight=" + roiheight + " posx="
							+ posx + " posy=" + posy + "]";
				}
			}
	 ...
	 */
	public static String encodeJpegToString(BufferedImage image) {
		...
		try {
			...
			LOGGER.log(Level.SEVERE, "encodeJpegToString", e);
		}
